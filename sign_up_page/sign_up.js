...
const clickButtonLog = (event) =>{
    ...
    let requestOptions = {
      ...
      fetch(`https://kokietech-production.up.railway.app/engineer-login/${usernameValue}/${passwordValue}`, requestOptions)
...
const clickButtonSign = (event) => {
    ...
    fetch("https://kokietech-production.up.railway.app/engineer/", requestOptions)
    .then(response => response.json())
