...
class post {
    ...
    static postAPostToDB(description, tech1, tech2, title, url,userId) {
            return pool.query(
            'INSERT INTO post(description,tech1,tech2,title,url,userId) VALUES($1, $2, $3, $4, $5,$6) RETURNING *',[description, tech1, tech2, title, url,userId]);
    }
